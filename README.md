...
# Reflection (ongoing)
What I thought would be a small one or two day project has taken me longer than I expected. I underestimated how strict Rust's compiler *actually* is, as well as how verbose the syntax is (although this is for good reason as laid out in The Book). As of writing (12/13/2025), I am still not finished with the project :[. </br>
